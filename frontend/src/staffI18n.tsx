...
const en = {
  ...
  clientId: 'Client ID', profileStatus: 'Profile status', active: 'Active', frozen: 'Frozen', deleted: 'Deleted', resetPassword: 'Reset temporary password',
  ...
  login: 'Login', temporaryPassword: 'Temporary password', copyCredentials: 'Copy login and password', adjustBalance: 'Adjust client balance', currentBalance: 'Current balance',
  creditAmount: 'Credit amount', applying: 'Applying…', applyCredit: 'Apply credit', clearConfirm: 'Clear all confirmation codes for this client? This action cannot be undone.',
  ...
  progress: '{used} of {required} codes entered', showAll: 'Show all', freezeAction: 'Freeze', deleteAction: 'Delete',
  ...
  receivedAsset: 'Received {asset}', sentAsset: 'Sent {asset}', boughtAsset: 'Bought {asset}', swappedAssets: 'Swapped {asset} to {target}', withdrawalAsset: 'Withdrew {asset}', loadingOperations: 'Loading Operations…', closeDialog: 'Close dialog', unexpectedError: 'Something went wrong. Try again.',
} as const
...
const ru: Record<StaffTextKey, string> = {
  ...
  clientId: 'ID клиента', profileStatus: 'Статус профиля', active: 'Активен', frozen: 'Заморожен', deleted: 'Удалён', resetPassword: 'Сбросить временный пароль',
  ...
  login: 'Логин', temporaryPassword: 'Временный пароль', copyCredentials: 'Скопировать логин и пароль', adjustBalance: 'Изменение баланса клиента', currentBalance: 'Текущий баланс',
  creditAmount: 'Сумма пополнения', applying: 'Применяем…', applyCredit: 'Пополнить', clearConfirm: 'Удалить все коды подтверждения этого клиента? Это действие нельзя отменить.',
  ...
  progress: 'Введено кодов: {used} из {required}', showAll: 'Показать все', freezeAction: 'Заморозить', deleteAction: 'Удалить',
  ...
  receivedAsset: 'Получено {asset}', sentAsset: 'Отправлено {asset}', boughtAsset: 'Куплено {asset}', swappedAssets: 'Обмен {asset} на {target}', withdrawalAsset: 'Выведено {asset}', loadingOperations: 'Загрузка Operations…', closeDialog: 'Закрыть окно', unexpectedError: 'Что-то пошло не так. Попробуйте ещё раз.',
}
...
const uk: Record<StaffTextKey, string> = {
  ...
  clientId: 'ID клієнта', profileStatus: 'Статус профілю', active: 'Активний', frozen: 'Заморожений', deleted: 'Видалений', resetPassword: 'Скинути тимчасовий пароль',
  ...
  login: 'Логін', temporaryPassword: 'Тимчасовий пароль', copyCredentials: 'Копіювати логін і пароль', adjustBalance: 'Зміна балансу клієнта', currentBalance: 'Поточний баланс',
  creditAmount: 'Сума поповнення', applying: 'Застосовуємо…', applyCredit: 'Поповнити', clearConfirm: 'Видалити всі коди підтвердження цього клієнта? Цю дію не можна скасувати.',
  ...
  progress: 'Введено кодів: {used} з {required}', showAll: 'Показати всі', freezeAction: 'Заморозити', deleteAction: 'Видалити',
  ...
  receivedAsset: 'Отримано {asset}', sentAsset: 'Надіслано {asset}', boughtAsset: 'Придбано {asset}', swappedAssets: 'Обмін {asset} на {target}', withdrawalAsset: 'Виведено {asset}', loadingOperations: 'Завантаження Operations…', closeDialog: 'Закрити вікно', unexpectedError: 'Щось пішло не так. Спробуйте ще раз.',
}
